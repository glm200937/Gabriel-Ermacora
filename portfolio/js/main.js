...
const translations = {
  fr: {
    ...
    about: {
      ...
      exp_sdis_title: "Stage Technicien Systèmes & Réseaux / Cybersécurité",
      exp_sdis_desc: "Déploiement VPN Stormshield + BitLocker pour 170 agents, gestion d'incident cybersécurité (analyse de logs, EDR), préparation infrastructure réseau (RJ45 Cat 6A/8, fibre), administration Active Directory et déploiement de postes Windows 10/11, étude NTP et architecture logicielle.",
      exp_sdis_tags: "Cybersécurité, Réseau, Windows, Active Directory",
      exp_phonekaze_title: "Stage Technicien & Développeur",
      exp_phonekaze_desc: "Réparation hardware (écrans, batteries, connecteurs sur +30 modèles Android/iOS), développement web (site vitrine responsive + application métier de gestion des réparations CRUD), gestion stocks/clients/devis.",
      exp_phonekaze_tags: "Développement Web, Hardware, Android, iOS",
      exp_polytech_title: "Stage Département Ingénierie",
      exp_polytech_desc: "Programmation et tests de robots mBot et Boe-Bot, déplacements autonomes, projet de podium automatisé avec servomoteurs (Arduino).",
      exp_polytech_tags: "Robotique, Arduino, C++",
      exp_lycee_title: "Stage Service Informatique",
      exp_lycee_desc: "Mise à jour Apple TV et imprimantes connectées, gestion des iPads via MDM « Students », support technique CCF de langue.",
      exp_lycee_tags: "MDM, Apple, Maintenance",
      report_download: "Télécharger le rapport",
      report_sdis_title: "Rapport de stage SDIS 37",
      report_sdis_desc: "Rapport de stage effectué au SDIS 37 en Juin 2026."
    },
    // Page: Projects
    projects: {
      title: "Mes Projets",
      ...
      github_projects_title: "Projets GitHub",
      github_projects_subtitle: "Mes dépôts personnels en cours de développement",
      status_inprogress: "En cours",
      project_gabriel_ermacora_desc: "Mon site portfolio personnel.",
      project_ironflow_desc: "Application mobile de musculation type Strava, combinant suivi d'entraînement (charges, reps, PR), statistiques de progression et réseau social fitness avec feed, défis et classements entre utilisateurs.",
      project_opencollab_desc: "Plateforme collaborative open source et auto-hébergeable regroupant gestion de fichiers, notes, projets, dépôts Git et édition collaborative dans une interface unique ; alternative à GitHub, Notion et Nextcloud.",
      project_decision_maker_desc: "Outil d'aide à la prise de décision.",
      project_glm_password_generator_desc: "Générateur de mots de passe."
    },
    // Page: Skills
    skills: {
      title: "Compétences",
  ...
  en: {
    ...
    about: {
      ...
      exp_sdis_title: "Systems & Network Technician / Cybersecurity Internship",
      exp_sdis_desc: "Deployment of Stormshield VPN + BitLocker for 170 agents, cybersecurity incident management (log analysis, EDR), network infrastructure preparation (RJ45 Cat 6A/8, fiber), Active Directory administration and Windows 10/11 workstation deployment, NTP study and software architecture.",
      exp_sdis_tags: "Cybersecurity, Network, Windows, Active Directory",
      exp_phonekaze_title: "Technician & Developer Internship",
      exp_phonekaze_desc: "Hardware repair (screens, batteries, connectors on +30 Android/iOS models), web development (responsive showcase website + CRUD repair management business application), stock/client/quote management.",
      exp_phonekaze_tags: "Web Development, Hardware, Android, iOS",
      exp_polytech_title: "Engineering Department Internship",
      exp_polytech_desc: "Programming and testing of mBot and Boe-Bot robots, autonomous movement tests, automated podium project with servomotors (Arduino).",
      exp_polytech_tags: "Robotics, Arduino, C++",
      exp_lycee_title: "IT Service Internship",
      exp_lycee_desc: "Update Apple TV and connected printers, manage iPads via MDM “Students”, language CCF technical support.",
      exp_lycee_tags: "MDM, Apple, Maintenance",
      report_download: "Download report",
      report_sdis_title: "SDIS 37 Internship Report",
      report_sdis_desc: "Internship report completed at SDIS 37 in June 2026."
    },
    // Page: Projects
    projects: {
      title: "My Projects",
      ...
      github_projects_subtitle: "My personal repositories currently under development",
      status_inprogress: "In progress",
      project_gabriel_ermacora_desc: "My personal portfolio website.",
      project_ironflow_desc: "Strava-like mobile fitness application, combining workout tracking (loads, reps, PRs), progress statistics, and a fitness social network with feed, challenges, and leaderboards among users.",
      project_opencollab_desc: "Open-source and self-hostable collaborative platform combining file management, notes, projects, Git repositories, and collaborative editing in a single interface; an alternative to GitHub, Notion, and Nextcloud.",
      project_decision_maker_desc: "Decision-making aid tool.",
      project_glm_password_generator_desc: "Password generator."
    },
    // Page: Skills
    skills: {
      title: "Skills",
...
// === CONSOLE MESSAGE ===
console.log('%cBienvenue sur mon portfolio !', 'color: #3b82f6; font-size: 20px; font-weight: bold;');
